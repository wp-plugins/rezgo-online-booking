...
* Fixed an issue that would cause the calendar to hang if there was no
availability.
* Added some default settings to the plugin config, including a
warning about the default permalink structure.
